...
- Mobile (démarcheurs, bailleurs, locataires) : **Flutter 3.x, Riverpod, Drift (SQLite), go_router, dio**. Offline-first. — _Cible du produit. L'étape en cours est arbitrée par [ADR-013](adr/0013-web-installable-surface-universelle.md) : le web installable est la surface universelle aujourd'hui, Flutter couvre le terrain hors réseau et le portail bailleur ; la parité mobile est différée, non abandonnée._
