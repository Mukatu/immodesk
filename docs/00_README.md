...
| 7     | [07_guide_de_demarrage_local.md](07_guide_de_demarrage_local.md) | Tous                            | Comment voir et essayer l'application depuis un poste : charte graphique, trois façons de lancer le dashboard web, ports, comptes de démonstration, lancement mobile, dépannage.                                       |
