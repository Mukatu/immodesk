...
/**
 * Miniature de photo d'un poste d'état des lieux. Comme `ProofLink`
 * (components/business/proof-link.tsx), aucune URL directe n'est disponible :
 * on résout l'URL de téléchargement signée à la demande via
 * `fetchDocumentDownloadUrl`, sans la stocker.
 */
