...
export const OtpPurpose = ['LOGIN', 'PHONE_VERIFICATION', 'PASSWORD_RESET', 'SENSITIVE_ACTION'] as const;
...
export const IdDocumentType = ['CNI', 'PASSPORT', 'RESIDENCE_PERMIT', 'DRIVING_LICENSE', 'VOTER_CARD', 'RCCM', 'NIU', 'OTHER'] as const;
...
export const PropertyType = ['HOUSE', 'VILLA', 'APARTMENT_BUILDING', 'COMPOUND', 'COMMERCIAL_BUILDING', 'MIXED_USE', 'LAND', 'WAREHOUSE', 'OTHER'] as const;
export type PropertyType = (typeof PropertyType)[number];

export const UnitType = ['STUDIO', 'ROOM', 'APARTMENT', 'HOUSE', 'SHOP', 'OFFICE', 'WAREHOUSE', 'PARKING', 'LAND_PLOT', 'OTHER'] as const;
export type UnitType = (typeof UnitType)[number];

export const UnitStatus = ['AVAILABLE', 'RESERVED', 'OCCUPIED', 'UNDER_MAINTENANCE', 'UNAVAILABLE'] as const;
export type UnitStatus = (typeof UnitStatus)[number];

export const MeterType = ['ELECTRICITY_E2C', 'WATER_LCDE', 'GAS', 'PRIVATE_SUBMETER', 'SOLAR', 'OTHER'] as const;
export type MeterType = (typeof MeterType)[number];

export const TariffBasis = ['PER_UNIT_CONSUMED', 'FLAT_MONTHLY', 'PER_OCCUPANT', 'PER_SQUARE_METER', 'SHARED_PRORATA'] as const;
...
export const LeaseStatus = ['DRAFT', 'PENDING_SIGNATURE', 'ACTIVE', 'NOTICE_GIVEN', 'TERMINATED', 'EXPIRED', 'CANCELLED'] as const;
...
export const LeaseDocumentKind = ['CONTRACT', 'AMENDMENT', 'NOTICE', 'TERMINATION', 'INVENTORY', 'INSURANCE', 'OTHER'] as const;
...
export const DepositStatus = ['PENDING', 'PARTIALLY_PAID', 'HELD', 'PARTIALLY_REFUNDED', 'REFUNDED', 'FORFEITED'] as const;
export type DepositStatus = (typeof DepositStatus)[number];

export const DepositMovementType = ['COLLECTION', 'REFUND', 'DEDUCTION', 'TRANSFER', 'ADJUSTMENT'] as const;
...
export const InspectionStatus = ['DRAFT', 'IN_PROGRESS', 'PENDING_SIGNATURE', 'SIGNED', 'DISPUTED', 'CANCELLED'] as const;
...
export const InvoiceLineType = ['RENT', 'WATER_CHARGE', 'ELECTRICITY_CHARGE', 'SERVICE_CHARGE', 'PENALTY', 'DEPOSIT', 'AGENCY_FEE', 'REPAIR_REBILL', 'DISCOUNT', 'OTHER'] as const;
export type InvoiceLineType = (typeof InvoiceLineType)[number];

export const PenaltyBasis = ['RATE_BPS_PER_DAY', 'RATE_BPS_PER_MONTH', 'FLAT_AMOUNT', 'FLAT_AMOUNT_PER_DAY'] as const;
...
export const PaymentStatus = ['PENDING', 'PENDING_VERIFICATION', 'CONFIRMED', 'REJECTED', 'CANCELLED', 'REVERSED'] as const;
...
export const RemittanceStatus = ['OPEN', 'SUBMITTED', 'VERIFIED', 'DEPOSITED', 'REJECTED', 'CANCELLED'] as const;
export type RemittanceStatus = (typeof RemittanceStatus)[number];

export const DeclarationStatus = ['SUBMITTED', 'UNDER_REVIEW', 'MATCHED', 'APPROVED', 'REJECTED', 'CANCELLED'] as const;
...
export const MomoStatus = ['INITIATED', 'PENDING', 'SUCCEEDED', 'FAILED', 'EXPIRED', 'CANCELLED', 'REFUNDED'] as const;
...
export const CheckStatus = ['RECEIVED', 'DEPOSITED', 'CLEARED', 'BOUNCED', 'CANCELLED', 'RETURNED'] as const;
...
export const BankStatementStatus = ['UPLOADED', 'PARSING', 'PARSED', 'RECONCILING', 'RECONCILED', 'FAILED'] as const;
...
export const SequenceKind = ['CASH_RECEIPT', 'RENT_INVOICE', 'RECEIPT', 'OWNER_STATEMENT', 'REMITTANCE', 'EXPENSE', 'PAYOUT', 'SUBSCRIPTION_INVOICE'] as const;
export type SequenceKind = (typeof SequenceKind)[number];

export const ExpenseCategory = ['REPAIR', 'MAINTENANCE', 'PLUMBING', 'ELECTRICITY', 'CLEANING', 'SECURITY', 'UTILITY_BILL', 'TAX', 'INSURANCE', 'SYNDIC_FEE', 'LEGAL_FEE', 'TRAVEL', 'SUPPLIES', 'OTHER'] as const;
export type ExpenseCategory = (typeof ExpenseCategory)[number];

export const ExpenseStatus = ['DRAFT', 'SUBMITTED', 'APPROVED', 'PAID', 'REBILLED', 'REJECTED', 'CANCELLED'] as const;
...
export const CommissionBasis = ['RATE_BPS_ON_RENT_COLLECTED', 'RATE_BPS_ON_RENT_DUE', 'FLAT_AMOUNT_PER_MONTH', 'FLAT_AMOUNT_PER_LEASE'] as const;
...
export const OwnerStatementLineType = ['RENT_COLLECTED', 'CHARGE_COLLECTED', 'COMMISSION', 'EXPENSE', 'VAT', 'DEPOSIT_HELD', 'CARRY_FORWARD', 'ADJUSTMENT', 'OTHER'] as const;
export type OwnerStatementLineType = (typeof OwnerStatementLineType)[number];

export const PayoutStatus = ['PENDING', 'APPROVED', 'PROCESSING', 'PAID', 'FAILED', 'CANCELLED'] as const;
export type PayoutStatus = (typeof PayoutStatus)[number];

export const MaintenanceStatus = ['OPEN', 'ACKNOWLEDGED', 'ASSIGNED', 'IN_PROGRESS', 'ON_HOLD', 'RESOLVED', 'CLOSED', 'REJECTED'] as const;
...
export const MaintenanceReporter = ['TENANT', 'LANDLORD', 'COLLECTOR', 'MANAGER', 'INSPECTION'] as const;
...
export const MessageStatus = ['QUEUED', 'SENT', 'DELIVERED', 'READ', 'FAILED', 'REJECTED', 'EXPIRED'] as const;
export type MessageStatus = (typeof MessageStatus)[number];

export const DunningStepStatus = ['PENDING', 'RUNNING', 'SENT', 'SKIPPED', 'FAILED', 'CANCELLED'] as const;
export type DunningStepStatus = (typeof DunningStepStatus)[number];

export const DunningTrigger = ['DAYS_BEFORE_DUE', 'DAYS_AFTER_DUE', 'ON_ISSUE', 'ON_OVERDUE'] as const;
export type DunningTrigger = (typeof DunningTrigger)[number];

export const DocumentKind = ['ID_DOCUMENT', 'LEASE_CONTRACT', 'MANDATE', 'RECEIPT_PDF', 'INVOICE_PDF', 'CASH_RECEIPT_PDF', 'TRANSFER_PROOF', 'CHECK_IMAGE', 'BANK_STATEMENT', 'INSPECTION_REPORT', 'INSPECTION_PHOTO', 'MAINTENANCE_PHOTO', 'SIGNATURE', 'OWNER_STATEMENT_PDF', 'EXPENSE_INVOICE', 'PROPERTY_PHOTO', 'OTHER'] as const;
...
export const WebhookSource = ['CINETPAY', 'PAWAPAY', 'MTN_MOMO', 'AIRTEL_MONEY', 'WHATSAPP_CLOUD', 'SMS_GATEWAY', 'OTHER'] as const;
...
export const SyncBatchStatus = ['RECEIVED', 'VALIDATING', 'APPLIED', 'PARTIALLY_APPLIED', 'REJECTED', 'FAILED'] as const;
export type SyncBatchStatus = (typeof SyncBatchStatus)[number];

export const AuditAction = ['CREATE', 'UPDATE', 'DELETE', 'STATE_TRANSITION', 'LOGIN', 'EXPORT', 'IMPORT'] as const;
export type AuditAction = (typeof AuditAction)[number];

export const SubscriptionStatus = ['TRIALING', 'ACTIVE', 'PAST_DUE', 'SUSPENDED', 'CANCELLED', 'EXPIRED'] as const;
...
export const ReferralPartnerStatus = ['PENDING_VERIFICATION', 'ACTIVE', 'SUSPENDED', 'CLOSED'] as const;
...
export const ReferralCommissionStatus = ['ACCRUED', 'APPROVED', 'PAID', 'REVERSED', 'CANCELLED'] as const;
export type ReferralCommissionStatus = (typeof ReferralCommissionStatus)[number];

export const ReferralSource = ['CODE_AT_SIGNUP', 'PARTNER_REGISTERED_PROPERTY', 'LINK', 'MANUAL_ADMIN'] as const;
